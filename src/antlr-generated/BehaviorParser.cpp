...
void behaviorParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	...
  	1,10,1,12,1,17,9,1,1,1,0,1,2,2,0,2,0,1,1,0,2,3,17,0,4,1,0,0,0,2,7,1,0,
  	0,0,4,5,3,2,1,0,5,6,5,0,0,1,6,1,1,0,0,0,7,8,6,1,-1,0,8,9,5,1,0,0,9,15,
...
tree::TerminalNode* BehaviorParser::RootContext::EOF() {
  return getToken(BehaviorParser::EOF, 0);
}
